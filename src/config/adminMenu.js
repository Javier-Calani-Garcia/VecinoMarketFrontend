  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        to: '/recomendados',
        implementado: true,
        ocultoParaStaff: true,
        descripcion: 'Motor de recomendación de productos personalizado según el historial de cada comprador (vista del comprador en "Recomendado para ti").',
      },
      {
        cu: 'CU22',
